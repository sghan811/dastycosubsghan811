...
router.patch("/post/:id/unlikeleftlikeright", auth, postCtrl.UnLikeleftLikerightPost);
router.patch("/post/:id/likeleftunlikeright", auth, postCtrl.LikeleftUnLikerightPost);
